...
### ✅ 使うべきとき
- **サイト構築前の設計段階（/keyword-research 完了後）**
- カテゴリー/ラベル構造を見直すとき
- 内部リンク戦略を立案するとき
- 記事が増えてきてカテゴリー整理が必要なとき（20-30記事時）
- WordPress移行を検討しているとき（URL設計見直し）

### ❌ 使わない方がいいとき
- キーワードリストが固まっていない段階（/keyword-research を先に）
- すでにサイト構造が確定していて、記事作成を進める段階
- サイト構造より先に記事を増やすべき段階

### 📍 ワークフロー上の位置
```
/keyword-research → このスキル → /content-calendar
```
